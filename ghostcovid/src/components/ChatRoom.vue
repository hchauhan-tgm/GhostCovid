  ...
  <div class="chat-window">
    <div class="row" style="width: 100%">
      <div class="col s4">
        ...
        <a
          href="https://addons.mozilla.org/de/firefox/addon/moesif-origin-cors-changer1/"
          target="_blank"
          ><button class="erweiterungbutton">FireFox</button></a
        >
        <a
          href="https://chrome.google.com/webstore/detail/moesif-origin-cors-change/digfbfaphojjndkpccljibejjbppifbc"
          target="_blank"
          ><button class="erweiterungbutton">Chrome</button></a
        >
        <form class="msginput-container" v-on:submit="sendMessage">
          <textarea
            id="icon_prefix2"
            type="text"
            class="validate msginput"
            v-model="msg"
          ></textarea>
          <button
            class="sendbutton"
      ...
      <div class="col s8">
        <div class="messages">
          ...
          >
            ...
            <div class="msgdate">{{ message.aktdate }}</div>
            <br />
