        ...
        if (
          ...
          setTimeout(() => {
            clickedCard.className =
              clickedCard.className.replace("done", "").trim() + " greyC";
            target.className =
              target.className.replace("done", "").trim() + " greyC";
            clickedCard = null;
            preventClick = false;
          }, 500);
          moves++;
