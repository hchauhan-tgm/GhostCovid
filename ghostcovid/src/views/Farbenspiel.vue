  ...
  methods: {
    ...
    shuffle: function () {
      ...
      const richtigeKombinationen = [
        ["grün", " tSchwarz", " gruenRichtig"],
        ["gelb", " tSchwarz", " gelbRichtig"],
        ["blau", " tSchwarz", " blauRichtig"],
        ["rot", " tSchwarz", " rotRichtig"],
      ];
      ...
      let zufallKombinationR =
        richtigeKombinationen[
          Math.floor(Math.random() * richtigeKombinationen.length)
        ];
      let zKombi = false;
      for (let i = 0; i < 2; i++) {
        ...
        if (zKombi === false) {
          for (let j = 0; j < 2; j++) {
            if (
              document.getElementById(aktKarte).classList.contains("tgelb") ===
              true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("tgelb", "")
                .trim();
            } else if (
              document.getElementById(aktKarte).classList.contains("trot") ===
              true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("trot", "")
                .trim();
            } else if (
              document.getElementById(aktKarte).classList.contains("tblau") ===
              true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("tblau", "")
                .trim();
            } else if (
              document.getElementById(aktKarte).classList.contains("tGruen") ===
              true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("tGruen", "")
                .trim();
            } else if (
              document
                .getElementById(aktKarte)
                .classList.contains("tSchwarz") === true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("tSchwarz", "")
                .trim();
            } else if (
              document
                .getElementById(aktKarte)
                .classList.contains("trotHell") === true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("trotHell", "")
                .trim();
            } else if (
              document
                .getElementById(aktKarte)
                .classList.contains("tblauHell") === true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("tblauHell", "")
                .trim();
            } else if (
              document
                .getElementById(aktKarte)
                .classList.contains("tGruenHell") === true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("tGruenHell", "")
                .trim();
            } else if (
              document
                .getElementById(aktKarte)
                .classList.contains("tgelbHell") === true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("tgelbHell", "")
                .trim();
            } else if (
              document
                .getElementById(aktKarte)
                .classList.contains("gelbRichtig") === true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("gelbRichtig", "")
                .trim();
            } else if (
              document
                .getElementById(aktKarte)
                .classList.contains("rotRichtig") === true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("rotRichtig", "")
                .trim();
            } else if (
              document
                .getElementById(aktKarte)
                .classList.contains("blauRichtig") === true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("blauRichtig", "")
                .trim();
            } else if (
              document
                .getElementById(aktKarte)
                .classList.contains("gruenRichtig") === true
            ) {
              document.getElementById(aktKarte).className = document
                .getElementById(aktKarte)
                .className.replace("gruenRichtig", "")
                .trim();
            }
          }
          ...
          for (let i = 0; i < 15; i++) {
            for (let j = 0; j < 2; j++) {
              if (
                document
                  .getElementById(zuweisen[i])
                  .classList.contains("tgelb") === true
              ) {
                document.getElementById(zuweisen[i]).className = document
                  .getElementById(zuweisen[i])
                  .className.replace("tgelb", "")
                  .trim();
              } else if (
                ...
                document
                  .getElementById(zuweisen[i])
                  .classList.contains("tGruen") === true
              ) {
                document.getElementById(zuweisen[i]).className = document
                  .getElementById(zuweisen[i])
                  .className.replace("tGruen", "")
            ...
            let zufallKombinationF =
              falscheKombinationen[
                Math.floor(Math.random() * falscheKombinationen.length)
              ];
            document.getElementById(zuweisen[i]).textContent =
              zufallKombinationF[0];
            document.getElementById(zuweisen[i]).className +=
              zufallKombinationF[1];
            document.getElementById(zuweisen[i]).className +=
              zufallKombinationF[2];
            console.log(zuweisen);
          }
        }
      }
